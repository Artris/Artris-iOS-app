...
class LocalizationViewController: UIViewController,ARSessionDelegate
{
    ...
    func session(_ session: ARSession, didUpdate frame: ARFrame) {
        ...
        /*If the position of the shadow binder is default: (0,0,0), keep it as nil*/
        ...
        /*Once the object has been placed, the "next" button should appear to allow the user to transition to the game*/
    ...
    @IBAction func nextBtnPressed(_ sender: Any) {
        ...
        nextBtn.isHidden = true
        /*Set the ARSCNView Delegate to nil to stabilize the position of the grid*/
